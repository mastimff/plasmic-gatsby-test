...
import * as sty from "./PlasmicTextInput.module.css" // plasmic-import: rj77NDhjwwAh1v/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg" // plasmic-import: ZzM8ezyXJttSxL/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__iKOal)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ivp0U)}
                role={"img"}
              />
            ),
