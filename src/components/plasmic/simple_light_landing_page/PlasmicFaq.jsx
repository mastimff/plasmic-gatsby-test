...
import * as sty from "./PlasmicFaq.module.css" // plasmic-import: qjGnbFdja6Cna6/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kwzVk)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__eoRmJ)}>
          <div className={classNames(projectcss.all, sty.freeBox__k8AWd)}>
            {p.renderPlasmicSlot({
