...
import * as sty from "./PlasmicIconLink.module.css" // plasmic-import: hwLJ9MvhnklLR/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__hCwNr)}
              role={"img"}
            />
          ),
